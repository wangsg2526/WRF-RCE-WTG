...
acqfx = acqfx_nc.get(start=[tstart],count=[2],stride=[nread] )
acqfx = acqfx

rain = rain_nc.get(start=[tstart],count=[2],stride=[nread] )
raindailymean = rain 
...
aclhf = aclh_nc.get(start=[tstart],count=[2],stride=[nread] )
aclhfdailymean = aclhf/86400
